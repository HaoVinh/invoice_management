...
import 'package:invoice_management/screens/check_sheet_products_screen/screens/check_sheet_products.dart';
import 'package:invoice_management/utils/utils.dart';
...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  _onLoad(LoadProductsEvent event, Emitter<ProductState> emit) async {
    try {
      ...
      if (products != null && products.isEmpty && isExistCheckSheet.data!.isEmpty) {emit(ProductLoaded(products: products, hasNext: false, nextPage: 1));
      } else {
